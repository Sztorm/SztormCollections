...
namespace Sztorm.Collections
{
    ...
    ///     is less than or equal to <see cref="InnerObject"/>.
    /// </summary>
    ...
    public readonly struct LessThanOrEqualToPredicate<T> : IPredicate<T> where T : IComparable<T>
    {
        ...
        ///     whether any other <typeparamref name="T"/> object is less than or equal to object
        ///     passed in constructor.
        /// </summary>
        /// <param name="obj">The object which may be used in comparisons.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LessThanOrEqualToPredicate(T obj) => innerObj = obj;

        /// <summary>
        ///     Returns a value indicating whether <paramref name="other"/> is less than or equal
        ///     to <see cref="InnerObject"/>.
        /// </summary>
