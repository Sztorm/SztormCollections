...
namespace Sztorm.Collections.Extensions
{
    public static partial class RectangularCollectionExtensions
    {
        ...
        public static Index2DCollection FindAllIndices<
            T, Index2DCollection, TRectCollection, TPredicate>(
        ...
        ///     Returns <see cref="ICollection{T}"/> containing all the indices of which items
        ///     match the conditions defined by the specified predicate.<br/>
        ///     Use <see cref="FindAllIndices{T, Index2DCollection, TRectCollection,
        ///     TPredicate}(TRectCollection, TPredicate)"/> to avoid virtual call.
        ///     <para>
        ///         Exceptions:<br/>
        ...
        /// <returns></returns>
        public static Index2DCollection FindAllIndices<
            T, Index2DCollection, TRectCollection>(
            ...
            where TRectCollection : IRectangularCollection<T>
        {
            ...
            try
            {
                return source.FindAllIndices<
                    T, Index2DCollection, TRectCollection, BoxedPredicate<T>>(
