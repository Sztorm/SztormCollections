...
namespace Sztorm.Collections.Extensions
{
    public static partial class RefReadOnlyRectangularCollectionExtensions
    {
        internal static ItemRequestResult<Index2D> FindLastIndexInternal<
            T, TRefReadOnlyRectCollection, TPredicate>(
            this TRefReadOnlyRectCollection source,
            Index2D startIndex,
        ...
        public static ItemRequestResult<Index2D> FindLastIndex<
            ...
            where TRefReadOnlyRectCollection : IRefReadOnlyRectangularCollection<T>
            where TPredicate : struct, IPredicate<T>
            => source.FindLastIndexInternal<T, TRefReadOnlyRectCollection, TPredicate>(
            ...
            where TPredicate : struct, IPredicate<T>
        {
            ...
            return source.FindLastIndexInternal<T, TRefReadOnlyRectCollection, TPredicate>(
        ...
        ///     Use <see cref="FindLastIndex{T, TRefReadOnlyRectCollection, TPredicate}
            ...
            where TRefReadOnlyRectCollection : IRefReadOnlyRectangularCollection<T>
        {
            ...
            return source.FindLastIndex<T, TRefReadOnlyRectCollection, BoxedPredicate<T>>(
        ...
        ///     Use <see cref="FindLastIndex{T, TRefReadOnlyRectCollection, TPredicate}
        ///     (TRefReadOnlyRectCollection, Index2D, Bounds2D, TPredicate)"/> to avoid
        ///     virtual call.
        ///     <para>
        ///         Exceptions:<br/>
        ///         <see cref="ArgumentNullException"/>: <paramref name="match"/> cannot be
