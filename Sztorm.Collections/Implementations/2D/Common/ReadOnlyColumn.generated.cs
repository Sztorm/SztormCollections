...
namespace Sztorm.Collections
{
    ...
    /// </summary>
    public readonly partial struct ReadOnlyColumn<T, TCollection> :
        ...
        where TCollection : IReadOnlyRectangularCollection<T>
    {
        ...
        public ReadOnlyColumn(TCollection collection, int index)
        {
        ...
        /// <summary>
        ///     Returns an <see cref="IEnumerator{T}"/> for the <see cref="ReadOnlyColumn{T, TCollection}"/>.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///     Creates a <typeparamref name = "T"/>[] from this <see cref="ReadOnlyColumn{T, TCollection}"/> instance.
        /// </summary>
        /// <returns></returns>
        public T[] ToArray()
        {
