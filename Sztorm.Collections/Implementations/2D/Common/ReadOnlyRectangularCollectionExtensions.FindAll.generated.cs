...
namespace Sztorm.Collections.Extensions
{
    public static partial class ReadOnlyRectangularCollectionExtensions
    {
        ...
        public static TCollection FindAll<
            T, TCollection, TReadOnlyRectCollection, TPredicate>(
        ...
        ///     Use <see cref="FindAll{T, TCollection, TReadOnlyRectCollection, TPredicate}
        ///     (TReadOnlyRectCollection, TPredicate)"/> to avoid virtual
        ///     call.
        ///     <para>
        ///         Exceptions:<br/>
        ...
        /// </param>
        /// <returns></returns>
        public static TCollection FindAll<T, TCollection, TReadOnlyRectCollection>(
            ...
            where TReadOnlyRectCollection : IReadOnlyRectangularCollection<T>
        {
            ...
            try
            {
                return source.FindAll<
                    T, TCollection, TReadOnlyRectCollection, BoxedPredicate<T>>(
