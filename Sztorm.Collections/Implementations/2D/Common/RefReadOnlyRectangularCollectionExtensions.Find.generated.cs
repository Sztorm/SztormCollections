...
namespace Sztorm.Collections.Extensions
{
    public static partial class RefReadOnlyRectangularCollectionExtensions
    {
        ...
        public static ItemRequestResult<T> Find<T, TRefReadOnlyRectCollection, TPredicate>(
        ...
        ///     Use <see cref="Find{T, TRefReadOnlyRectCollection, TPredicate}
        ...
        /// </param>
        /// <returns></returns>
        public static ItemRequestResult<T> Find<T, TRefReadOnlyRectCollection>(
            ...
            where TRefReadOnlyRectCollection : IRefReadOnlyRectangularCollection<T>
        {
            ...
            return source.Find<T, TRefReadOnlyRectCollection, BoxedPredicate<T>>(
