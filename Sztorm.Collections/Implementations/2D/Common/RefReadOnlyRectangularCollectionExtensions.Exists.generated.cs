...
namespace Sztorm.Collections.Extensions
{
    public static partial class RefReadOnlyRectangularCollectionExtensions
    {
        ...
        public static bool Exists<T, TRefReadOnlyRectCollection, TPredicate>(
            ...
            => source.FindIndex<T, TRefReadOnlyRectCollection, TPredicate>(match).IsSuccess;

        /// <summary>
        ///     Determines whether any item that match the conditions defined by the specified
        ///     predicate exists in the current instance.<br/>  
        ///     Use <see cref="Exists{T, TRefReadOnlyRectCollection, TPredicate}
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Exists<T, TRefReadOnlyRectCollection>(
