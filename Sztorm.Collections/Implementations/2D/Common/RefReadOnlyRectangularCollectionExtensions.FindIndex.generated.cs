...
namespace Sztorm.Collections.Extensions
{
    public static partial class RefReadOnlyRectangularCollectionExtensions
    {
        ...
        public static ItemRequestResult<Index2D> FindIndex<
            ...
            where TRefReadOnlyRectCollection : IRefReadOnlyRectangularCollection<T>
            where TPredicate : struct, IPredicate<T>
            => source.FindIndexInternal<T, TRefReadOnlyRectCollection, TPredicate>(
            ...
            where TPredicate : struct, IPredicate<T>
        {
            ...
            return source.FindIndexInternal<T, TRefReadOnlyRectCollection, TPredicate>(
        ...
        ///     Use <see cref="FindIndex{T, TRefReadOnlyRectCollection, TPredicate}
            ...
            where TRefReadOnlyRectCollection : IRefReadOnlyRectangularCollection<T>
        {
            ...
            try
            {
                return source.FindIndex<T, TRefReadOnlyRectCollection, BoxedPredicate<T>>(
