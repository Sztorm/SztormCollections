...
namespace Sztorm.Collections.Extensions
{
    public static partial class RefRectangularCollectionExtensions
    {
        ...
        public static ItemRequestResult<Index2D> FindLastIndex<
            ...
            where TRefRectCollection : IRefRectangularCollection<T>
            where TPredicate : struct, IPredicate<T>
            => source.FindLastIndexInternal<T, TRefRectCollection, TPredicate>(
        ...
        ///     Use <see cref="FindLastIndex{T, TRefRectCollection, TPredicate}
            ...
            where TRefRectCollection : IRefRectangularCollection<T>
        {
            ...
            return source.FindLastIndex<T, TRefRectCollection, BoxedPredicate<T>>(
