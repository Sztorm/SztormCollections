...
namespace Sztorm.Collections.Extensions
{
    public static partial class ReadOnlyRectangularCollectionExtensions
    {
        ...
        public static ItemRequestResult<T> Find<T, TReadOnlyRectCollection, TPredicate>(
        ...
        ///     Use <see cref="Find{T, TReadOnlyRectCollection, TPredicate}
        ...
        /// </param>
        /// <returns></returns>
        public static ItemRequestResult<T> Find<T, TReadOnlyRectCollection>(
            ...
            where TReadOnlyRectCollection : IReadOnlyRectangularCollection<T>
        {
            ...
            return source.Find<T, TReadOnlyRectCollection, BoxedPredicate<T>>(
