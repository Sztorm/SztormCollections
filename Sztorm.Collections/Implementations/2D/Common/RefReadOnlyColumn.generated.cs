...
namespace Sztorm.Collections
{
    ...
    /// </summary>
    public readonly partial struct RefReadOnlyColumn<T, TCollection> :
        ...
        where TCollection : IRefReadOnlyRectangularCollection<T>
    {
        ...
        public RefReadOnlyColumn(TCollection collection, int index)
        {
        ...
        /// <summary>
        ///     Returns an <see cref="IEnumerator{T}"/> for the <see cref="RefReadOnlyColumn{T, TCollection}"/>.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///     Creates a <typeparamref name = "T"/>[] from this <see cref="RefReadOnlyColumn{T, TCollection}"/> instance.
        /// </summary>
        /// <returns></returns>
        public T[] ToArray()
        {
