...
namespace Sztorm.Collections.Extensions
{
    public static partial class RefRectangularCollectionExtensions
    {
        ...
        public static ItemRequestResult<T> FindLast<T, TRefRectCollection, TPredicate>(
        ...
        ///     Use <see cref="FindLast{T, TRefRectCollection, TPredicate}
        ...
        /// </param>
        /// <returns></returns>
        public static ItemRequestResult<T> FindLast<T, TRefRectCollection>(
            ...
            where TRefRectCollection : IRefRectangularCollection<T>
        {
            ...
            return source.FindLast<T, TRefRectCollection, BoxedPredicate<T>>(
