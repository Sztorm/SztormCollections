...
namespace Sztorm.Collections.Extensions
{
    public static partial class RefRectangularCollectionExtensions
    {
        ...
        public static ItemRequestResult<Index2D> FindIndex<
            ...
            where TRefRectCollection : IRefRectangularCollection<T>
            where TPredicate : struct, IPredicate<T>
            => source.FindIndexInternal<T, TRefRectCollection, TPredicate>(
            ...
            where TPredicate : struct, IPredicate<T>
        {
            ...
            return source.FindIndexInternal<T, TRefRectCollection, TPredicate>(
        ...
        ///     Use <see cref="FindIndex{T, TRefRectCollection, TPredicate}
        ///     (TRefRectCollection, Index2D, Bounds2D, TPredicate)"/> to avoid
        ///     virtual call.
        ///     <para>
        ///         Exceptions:<br/>
            ...
            where TRefRectCollection : IRefRectangularCollection<T>
        {
            ...
            try
            {
                return source.FindIndex<T, TRefRectCollection, BoxedPredicate<T>>(
