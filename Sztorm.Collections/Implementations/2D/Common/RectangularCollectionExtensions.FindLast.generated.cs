...
namespace Sztorm.Collections.Extensions
{
    public static partial class RectangularCollectionExtensions
    {
        ...
        public static ItemRequestResult<T> FindLast<T, TRectCollection, TPredicate>(
        ...
        ///     Use <see cref="FindLast{T, TRectCollection, TPredicate}
        ...
        /// </param>
        /// <returns></returns>
        public static ItemRequestResult<T> FindLast<T, TRectCollection>(
            ...
            where TRectCollection : IRectangularCollection<T>
        {
            ...
            return source.FindLast<T, TRectCollection, BoxedPredicate<T>>(
