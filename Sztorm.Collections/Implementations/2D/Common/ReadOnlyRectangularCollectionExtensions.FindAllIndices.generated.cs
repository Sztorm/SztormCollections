...
namespace Sztorm.Collections.Extensions
{
    public static partial class ReadOnlyRectangularCollectionExtensions
    {
        ...
        public static Index2DCollection FindAllIndices<
            T, Index2DCollection, TReadOnlyRectCollection, TPredicate>(
        ...
        ///     Returns <see cref="ICollection{T}"/> containing all the indices of which items
        ///     match the conditions defined by the specified predicate.<br/>
        ///     Use <see cref="FindAllIndices{T, Index2DCollection, TReadOnlyRectCollection,
        ///     TPredicate}(TReadOnlyRectCollection, TPredicate)"/> to avoid virtual call.
        ///     <para>
        ///         Exceptions:<br/>
        ...
        /// <returns></returns>
        public static Index2DCollection FindAllIndices<
            T, Index2DCollection, TReadOnlyRectCollection>(
            ...
            where TReadOnlyRectCollection : IReadOnlyRectangularCollection<T>
        {
            ...
            try
            {
                return source.FindAllIndices<
                    T, Index2DCollection, TReadOnlyRectCollection, BoxedPredicate<T>>(
