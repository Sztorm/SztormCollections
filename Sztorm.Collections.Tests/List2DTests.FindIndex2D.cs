...
namespace Sztorm.Collections.Tests
{
    ...
    public partial class List2DTests
    {
        public static class FindIndex2D
        {
            ...
            {
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(-1, 0));
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(0, -1));
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(2, 0));
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(0, 3));
                yield return new TestCaseData(new List2D<byte>(0, 0), new Index2D(0, 0));
                yield return new TestCaseData(new List2D<byte>(1, 0), new Index2D(0, 0));
                yield return new TestCaseData(new List2D<byte>(0, 1), new Index2D(0, 0));
            }

            private static IEnumerable<TestCaseData> InvalidCountTestCases()
            {
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(0, 0), -1);
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(1, 2), -1);
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(1, 1), 3);
                yield return new TestCaseData(new List2D<byte>(2, 3), new Index2D(0, 0), 7);
            }

            private static IEnumerable<TestCaseData> InvalidSectorTestCases()
            {
                yield return new TestCaseData(
                    new List2D<byte>(2, 3), new Index2D(0, 0), new Bounds2D(3, 0));
                yield return new TestCaseData(
                    new List2D<byte>(2, 3), new Index2D(0, 0), new Bounds2D(0, 4));
                yield return new TestCaseData(
                    new List2D<byte>(2, 3), new Index2D(1, 1), new Bounds2D(2, 0));
                yield return new TestCaseData(
                    new List2D<byte>(2, 3), new Index2D(1, 1), new Bounds2D(0, 3));
            }
