    ...
    public partial class List2DTests
    {
        public static partial class CopyTo
        {
            public static class System2DArray
            {
                ...
                {
                    yield return new TestCaseData(
                        new List2D<byte>(3, 5), new byte[4, 5], new Bounds2D(4, 5));
                    yield return new TestCaseData(
                        new List2D<byte>(3, 5), new byte[3, 6], new Bounds2D(3, 6));
                    yield return new TestCaseData(
                        new List2D<byte>(3, 5), new byte[2, 5], new Bounds2D(3, 5));
                    yield return new TestCaseData(
                        new List2D<byte>(3, 5), new byte[3, 4], new Bounds2D(3, 5));
                }
