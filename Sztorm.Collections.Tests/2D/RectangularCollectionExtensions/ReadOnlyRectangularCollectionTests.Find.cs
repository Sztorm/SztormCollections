    ...
    public partial class ReadOnlyRectangularCollectionTests
    {
        public static class Find
        {
            public static class First
            {
                ...
                public static void ThrowsExceptionIfMatchIsNull()
                    => Assert.Throws<ArgumentNullException>(
                        () => new ReadOnlyMatrix4x4().Find(match: null as Predicate<float>));
                ...
                public static ItemRequestResult<float> Test<FloatPredicate>(
                    ...
                    => matrix.Find<float, ReadOnlyMatrix4x4, FloatPredicate>(match);
            }
            ...
            public static class Last
            {
                ...
                public static void ThrowsExceptionIfMatchIsNull()
                    => Assert.Throws<ArgumentNullException>(
                        () => new ReadOnlyMatrix4x4().FindLast(match: null as Predicate<float>));
