        ...
        public static class FindIndex
        {
            public static class Predicate
            {
                ...
                public static void ThrowsExceptionIfMatchIsNull()
                    => Assert.Throws<ArgumentNullException>(
                        () => new RefReadOnlyMatrix4x4().FindIndex<float, RefReadOnlyMatrix4x4>(
                            match: null));
            ...
            private static IEnumerable<TestCaseData> InvalidSectorTestCases()
            {
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(0, 0), new Bounds2D(5, 0));
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(0, 0), new Bounds2D(0, 5));
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(1, 1), new Bounds2D(4, 0));
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(1, 1), new Bounds2D(0, 4));
            }
