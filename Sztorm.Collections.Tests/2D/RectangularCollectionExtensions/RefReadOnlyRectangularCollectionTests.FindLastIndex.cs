        ...
        public static class FindLastIndex
        {
            public static class Predicate
            {
                ...
                public static void ThrowsExceptionIfMatchIsNull()
                    => Assert.Throws<ArgumentNullException>(
                        () => new RefReadOnlyMatrix4x4().FindLastIndex<float, RefReadOnlyMatrix4x4>(
                            match: null));
            ...
            public static class IPredicate
            {
                ...
                public static ItemRequestResult<Index2D> Test<FloatPredicate>(
                    ...
                    => matrix.FindLastIndex<float, RefReadOnlyMatrix4x4, FloatPredicate>(match);
                ...
                public static ItemRequestResult<Index2D> Test<FloatPredicate>(
                    ...
                    where FloatPredicate : struct, IPredicate<float>
                    => matrix.FindLastIndex<float, RefReadOnlyMatrix4x4, FloatPredicate>(
                        startIndex, sector, match);
            }

            private static IEnumerable<TestCaseData> InvalidStartIndexTestCases()
            {
                yield return new TestCaseData(new RefReadOnlyMatrix4x4(), new Index2D(-1, 0));
                yield return new TestCaseData(new RefReadOnlyMatrix4x4(), new Index2D(0, -1));
                yield return new TestCaseData(new RefReadOnlyMatrix4x4(), new Index2D(4, 0));
                yield return new TestCaseData(new RefReadOnlyMatrix4x4(), new Index2D(0, 4));
            }

            private static IEnumerable<TestCaseData> InvalidSectorTestCases()
            {
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(3, 0), new Bounds2D(5, 0));
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(0, 3), new Bounds2D(0, 5));
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(2, 0), new Bounds2D(4, 0));
                yield return new TestCaseData(
                    new RefReadOnlyMatrix4x4(), new Index2D(0, 2), new Bounds2D(0, 4));
            }
