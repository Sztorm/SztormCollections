    ...
    public partial class RefReadOnlyRectangularCollectionTests
    {
        public static class Find
        {
            public static class First
            {
                ...
                public static void ThrowsExceptionIfMatchIsNull()
                    => Assert.Throws<ArgumentNullException>(
                        () => new RefReadOnlyMatrix4x4().Find(match: null as Predicate<float>));
                ...
                public static ItemRequestResult<float> Test<FloatPredicate>(
                    ...
                    => matrix.Find<float, RefReadOnlyMatrix4x4, FloatPredicate>(match);
            }
            ...
            public static class Last
            {
                ...
                public static void ThrowsExceptionIfMatchIsNull()
                    => Assert.Throws<ArgumentNullException>(
                        () => new RefReadOnlyMatrix4x4().FindLast(match: null as Predicate<float>));
                ...
                public static ItemRequestResult<float> Test<FloatPredicate>(
                    RefReadOnlyMatrix4x4 matrix, FloatPredicate match)
                    where FloatPredicate : struct, IPredicate<float>
                    => matrix.FindLast<float, RefReadOnlyMatrix4x4, FloatPredicate>(match);
            }
