        ...
        public static class FindLastIndex
        {
            public static class Predicate
            {
                ...
                public static void ThrowsExceptionIfMatchIsNull()
                    => Assert.Throws<ArgumentNullException>(
                        () => new ReadOnlyMatrix4x4().FindLastIndex<float, ReadOnlyMatrix4x4>(
                            match: null));
            ...
            public static class IPredicate
            {
                ...
                public static ItemRequestResult<Index2D> Test<FloatPredicate>(
                    ...
                    => matrix.FindLastIndex<float, ReadOnlyMatrix4x4, FloatPredicate>(match);
                ...
                public static ItemRequestResult<Index2D> Test<FloatPredicate>(
                    ...
                    where FloatPredicate : struct, IPredicate<float>
                    => matrix.FindLastIndex<float, ReadOnlyMatrix4x4, FloatPredicate>(
            ...
            private static IEnumerable<TestCaseData> InvalidSectorTestCases()
            {
                yield return new TestCaseData(
                    new ReadOnlyMatrix4x4(), new Index2D(3, 0), new Bounds2D(5, 0));
                yield return new TestCaseData(
                    new ReadOnlyMatrix4x4(), new Index2D(0, 3), new Bounds2D(0, 5));
                yield return new TestCaseData(
                    new ReadOnlyMatrix4x4(), new Index2D(2, 0), new Bounds2D(4, 0));
                yield return new TestCaseData(
                    new ReadOnlyMatrix4x4(), new Index2D(0, 2), new Bounds2D(0, 4));
            }
